...
export type ExecutiveMember = { id: number, name: string, role: string, image: any, linkedin: string, email: string, hovered: boolean };
export type ProjectManager = { id: number, name: string, project: string, image: any, linkedin: string, email: string, hovered: boolean };

export var executiveTeam: ExecutiveMember[];
export var projectManagers: ProjectManager[];

executiveTeam = [
    { id: 0, name: "Joel Happ", role: "President | Project Manager", image: member_0, linkedin: "https://www.linkedin.com/in/joel-happ/", email: "mailto:joel.happ1@ucalgary.ca", hovered: false },
...
projectManagers = [
    { id: 0, name: "Joel Happ", project: "Tech Start Website", image: member_0, linkedin: "https://www.linkedin.com/in/joel-happ/", email: "mailto:joel.happ1@ucalgary.ca", hovered: false },
    { id: 7, name: "Daniel Rashidian", project: "Resume Tracker", image: member_7, linkedin: "https://www.linkedin.com/in/armeen-rashidian-b12080195/", email: "mailto:armeenrn@gmail.com", hovered: false },
    { id: 8, name: "Felix Vaughan", project: "Social Media Hub", image: member_8, linkedin: "", email: "mailto:ezamabusiness@gmail.com", hovered: false },
    { id: 9, name: "Darryl Huët", project: "Supply Me", image: member_9, linkedin: "", email: "mailto:darryl.huet1@ucalgary.ca", hovered: false }
];