...
const HomePage = () => (
  <div className="homePage">
    ...
    <section className="homePage__section homePage__section--aboutUs">
      ...
      <div className="homePage__container">
        ...
        <p className="regularText" id="draft">
          ...
          technology to solve them. Every semester, our teams combine software,
          design, and strategy to complete awesome projects.
        </p>
        <p className="regularText">
          At Tech Start, our members learn to use new technologies, gain
          experience with professional development tools and methodologies, and
          master the art of collaboration. We give our members the support and
          mentorship to succeed here and in industry regardless of their
          previous experiences. We're also the top spot on campus to meet fellow
          tech enthusiasts, aspiring entrepreneurs, and innovators.
        </p>
        <Blobbie
          id={2}
          width={300}
    ...
    <section className="homePage__section homePage__section--sponsors">
      ...
      />{" "}
      {/* translate is relative to previous div*/}
      <Blobbie id={2} width={150} transform="translate(80vw, 0)" edge={false} />
      <Blobbie
        id={7}
        width={350}
