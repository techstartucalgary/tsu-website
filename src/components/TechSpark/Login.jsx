...
function Login(props) {
  ...
  function handleLogin(event) {
    // The event parameter will automatically be passed by React's onClick - read more at https://reactjs.org/docs/events.html
  ...
  return (
    <div className="loginStyling">
      ...
      <div className="switchStyling">
        ...
        <button className="registerSwitch" onClick={props.switchMode}>
          <i className="fa fa-user icon"></i> Sign Up
        </button>
        <div id="clearLogin" />
      </div>
      {invalidUsername ? (
