  ...
  function Branding() {
    return <section>
      ...
      <ul className="sectionContent">
        ...
        <li><Emoji symbol="🖥️ " />Logos: Want to use the Tech Start logo? You can download official versions from our Google Drive <a href="https://drive.google.com/drive/u/2/folders/1xYYzdgP9Asac6FP_omsDuCq0mEoaE8UY" target="_blank">here</a>! Please note that you can download the logos, but not delete or alter them.</li>
